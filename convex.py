...
# library 
sys.path.append("modules/CONVEX/library")
...
if __name__ == '__main__':
	...
	#print_results
	print( "--> " 		  + str((domain, elapsed_time, number_of_frontier_nodes, hyperparameters, conversations_path, wikidata_dump_path)))
	print( "MRR_score: 	" + str((question_counter, (total_mrr_score/float(question_counter)), total_mrr_score)))
	print( "P@1: 		" + str((question_counter, (total_precision_at_1_score/float(question_counter)), total_precision_at_1_score)))
	print( "H@5: 		" + str((question_counter, (total_hit_at_5_score/float(question_counter)), total_hit_at_5_score)))
	print("\n")
