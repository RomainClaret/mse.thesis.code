...
#answer = get_full_answer(question, answer_context=False, context_graph=False, verbose=True, timer=False, show_graph=False, k_spo=False, k_chatty=0, g_autocorrect=True)    
